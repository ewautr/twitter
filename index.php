      ...
      <div id="left">
        ...
        <div class="modal-wrapper post-tweet-modal-wrapper">
          <div class="modal post-tweet-modal">
            ...
            <form action=""class="post-tweet" id="post-tweet-modal" onsubmit="createTweet('newTweet-modal', 'post-tweet-modal'); return false">
              <img
                alt="profile image"
                class="profile-img"
              ...
              <div>
                ...
                <div class="bottom">
                  ...
                  <button class="btn" onclick="closeTweetModal()">Tweet</button>
                </div>
              </div>
            </form>
          </div>
