<div>
          <a href="/">
            <svg class="active" viewbox="0 0 24 24">
              <path
        ...
        <div>
          <a class="active" href="" onclick="return showPage('home')">
            <svg class="active" viewbox="0 0 24 24">
              <path
        ...
        <div>
          <a  href="" onclick="return showPage('notifications')">
            <svg viewbox="0 0 24 24">
              <path
        ...
        <div>
          <a href="" onclick="return showPage('bookmarks')">
            <svg viewbox="0 0 24 24">
              <path
        ...
        <div>
          <a href="" onclick="return showPage('profile')">
            <svg viewbox="0 0 24 24">
              <path
        ...
        <button class="btn" onclick="return showTweetModal()">
          Tweet
        </button>
