<div id="home" class="subpage">
  ...
  <form class="post-tweet" id="post-tweet" onsubmit="createTweet('newTweet', 'post-tweet'); return false">
    ...
    <div>
      <textarea name="tweet_body" id="newTweet" placeholder="What's happening?" type="text"></textarea>
      <div class="bottom">
        <div>
          <svg viewbox="0 0 24 24">
